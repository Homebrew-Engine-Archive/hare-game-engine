...
%newobject PyInputManager::createMouse(bool);
%newobject PyInputManager::createKeyboard(bool);
%newobject PyInputManager::createJoyStick(bool);
...
public:
    //void setListener(PyJoyStickListener* listener);
    //PyJoyStickListener* getListener();
};

class PyKeyListener : public PyInputObject
{
public:
...
class PyMouseListener : public PyInputObject
{
public:
