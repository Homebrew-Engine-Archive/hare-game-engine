...
#else
WX_DEFINE_ARRAY_WITH_DECL_PTR(wxTreeListItem *, wxArrayTreeListItems, class WXDLLIMPEXP_TL);
#endif

#include <wx/dynarray.h>
WX_DECLARE_OBJARRAY_WITH_DECL(wxTreeListColumnInfo, wxArrayTreeListColumnInfo, class WXDLLIMPEXP_TL);
