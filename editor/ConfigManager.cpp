...
namespace hare_editor
{
    HARE_IMPLEMENT_DYNAMIC_CLASS(AppConfigFile, Object, 0)
    {
        ...
        HARE_ENUM(show_folds, u8, Bool)
        HARE_ENUM(fold_xml, u8, Bool)
        HARE_ENUM(fold_comments, u8, Bool)
        HARE_ENUM(fold_preprocessor, u8, Bool)
        HARE_ENUM(fold_indicator, u8, FoldIndicator)
