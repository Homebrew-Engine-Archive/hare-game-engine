...
class WXDLLIMPEXP_TL wxTreeListItem;
class WXDLLIMPEXP_TL wxTreeListHeaderWindow;
class WXDLLIMPEXP_TL wxTreeListMainWindow;
...
class WXDLLIMPEXP_TL wxTreeListColumnInfo: public wxObject {
...
extern WXDLLIMPEXP_TL const wxChar* wxTreeListCtrlNameStr;


class WXDLLIMPEXP_TL wxTreeListCtrl : public wxControl
{
public:
    // creation
    // --------
